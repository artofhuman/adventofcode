...
result = min(intersections, key=manhat)
print(abs(result[0]) + abs(result[1]))


def get_count_steps(wise):
    steps = {}
    for i, p in enumerate(wise, 1):
...
steps1 = get_count_steps(w1)
steps2 = get_count_steps(w2)
